...
public class Seg {
	...
	private int col; 	// color of segment, only set by constructor and file reader
	...
	private void initColor(int distance, int cc) {
		...
		switch (part2) {
		case 0: setColor(Color.rgb(rgbValue, 20, 20)); break;
		case 1: setColor(Color.rgb(20, rgbValue, 20)); break;
		case 2: setColor(Color.rgb(20, 20, rgbValue)); break;
		case 3: setColor(Color.rgb(rgbValue, rgbValue, 20)); break;
		case 4: setColor(Color.rgb(20, rgbValue, rgbValue)); break;
		case 5: setColor(Color.rgb(rgbValue, 20, rgbValue)); break;
		default: setColor(Color.rgb(20, 20, 20)); break;
		}
	}

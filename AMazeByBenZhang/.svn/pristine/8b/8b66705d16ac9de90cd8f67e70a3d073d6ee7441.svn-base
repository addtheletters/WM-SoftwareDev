 ...
 *
 */
public class MapDrawer extends DefaultViewer implements NeedDimensions {

	// keep local copies of values determined in Maze.java
	int view_width;// = 400;
	int view_height;// = 400;
	int map_unit = Constants.MAP_UNIT;
	int map_scale = Constants.MAP_SCALE;
	int step_size = map_unit/Constants.INTERMEDIATE_STEPS;
	Cells seencells ; 

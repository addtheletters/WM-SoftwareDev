...
public class MazeFileReader {
	 ...
	 */
	public MazeFileReader(Context ctx, String filename) {
		load(ctx, filename) ;
	}
    ...
    public static MazeConfiguration loadFile(Context ctx, String filename){
        MazeFileReader reader = new MazeFileReader(ctx, filename);
        return reader.getMazeConfiguration();
    }
	 ...
	 */
	private void load(Context ctx, String filename)
	{
		try{

			File fXmlFile = new File(ctx.getFilesDir(), filename);
	...
	private BSPNode readBSPNode(Element eElement) {
		 ...
		 */
        //Log.v("MazeFileReader", "reading BSP node");

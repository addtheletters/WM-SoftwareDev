...
import edu.wm.cs.cs301.benzhang.amazebybenzhang.falstad.Constants;
...
import edu.wm.cs.cs301.benzhang.amazebybenzhang.falstad.SingleRandom;
...
public enum CardinalDirection {
	 ...
	 */
	public CardinalDirection rotateCounterCW(){
		switch(this) {
		case North : 
			return CardinalDirection.West ;
		case East : 
	...
	/**
	 * Gives the {@link edu.wm.cs.cs301.benzhang.amazebybenzhang.falstad.Robot.Direction} that this cardinal direction is to a robot.
	 * @param robot The robot whose perspective is used
	 * @return direction in which the cardinal direction points
	 */
	public Direction robotDirection(Robot robot){
		if( this == robot.getCurrentDirection() ){
			return Direction.FORWARD;
		}
		CardinalDirection comparisonFacing = robot.getCurrentDirection().rotateClockwise();
		if( comparisonFacing == this ){
			return Direction.RIGHT;
		}
		comparisonFacing = comparisonFacing.rotateClockwise();		
		if( comparisonFacing == this ){
		...
		//System.err.println("Could not determine what direction matched robot's facing direction.");
		return null;
	}

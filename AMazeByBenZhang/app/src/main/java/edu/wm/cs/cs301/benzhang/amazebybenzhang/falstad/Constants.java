...
public class Constants {
	...
	public static final int VIEW_WIDTH = 400; // default 400
	public static final int VIEW_HEIGHT = 400; // default 400

    public static final int MAP_SCALE = 50; // default 10
	public static final int MAP_UNIT = 128;//461; // default 128

    public static final int VIEW_Z = 50; // default 50
	public static final int MAX_VIEW_Z = 100; // default 100

	public static final int INTERMEDIATE_STEPS = 4; // default 4

	public static final int VIEW_OFFSET = MAP_UNIT/(INTERMEDIATE_STEPS * 2);
	public static final int STEP_SIZE = MAP_UNIT/INTERMEDIATE_STEPS;
	...
	// Seed for deterministic random behavior, value is not important as long as it is consistent
	public static final int DETERMINISTIC_SEED = 65536;
}

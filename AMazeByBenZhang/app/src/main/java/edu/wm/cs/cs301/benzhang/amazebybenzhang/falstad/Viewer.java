...
public interface Viewer {
	 ...
	 * @param ang
	 */
	public void redraw(MazePanel mazePanel, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, edu.wm.cs.cs301.benzhang.amazebybenzhang.falstad.RangeSet rset, int ang) ;
	/** 

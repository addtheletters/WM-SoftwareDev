...
//import edu.wm.cs.cs301.benzhang.amazebybenzhang.falstad.Maze;
...
public class MazeBuilder implements Runnable {
	...
	public MazeBuilder(boolean deterministic){
		if (deterministic)
		{
			int seed = Constants.DETERMINISTIC_SEED; // new Random().nextInt();
			System.out.println("Deterministic random seed set as: " + seed);

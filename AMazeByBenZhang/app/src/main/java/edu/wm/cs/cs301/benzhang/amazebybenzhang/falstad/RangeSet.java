...
public class RangeSet {
	...
	public boolean intersect(Point p) {
        //Log.v("RangeSet", "intersect range set is " + this);
        //Log.v("RangeSet", "intersect point is " + p);
		...
		for (int i = 0; i != ranges.size(); i++) {
            ...
            //Log.v("RangeSet", "after intersect op, point is " + p);
			return true;
		}
        //Log.v("RangeSet", "after intersect op, point is " + p);
		return false;
	...
	public String toString() {
		String sout = "[RangeSet: \n";
		for(int i = 0; i < ranges.size(); i++){
			sout += "\t" + ranges.elementAt(i) + "\n";
		}
		sout += "]";
		return sout;
	}
